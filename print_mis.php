    ...
    <img src="images/apjyothi.jpg" style="width:100%">
        ...
        <br/><b><?php echo $address; ?></b></p>
           ...
           <p>We are pleased to appoint you as a <b><?php echo $desig; ?></b>&nbsp;in our organization</p>
             <p><b>Job Title: MIS Executive </b></p>
             <p><b>Job description:</b></p>
             <ul>
                 <li><p>mHere Application maintenance</p></li>
                 
                 <li><p>FM NOC faults publishing</p></li>
                 
                 <li><p>Fault Management - Sharing the faults, Follow up and Status publishing</p></li>
                  
                  <li><p>PM Calls Count and report publishing</p></li>
                   
                  <li><p>Manual attendance collection & publishing to AFMs on daily basis.</p></li>
                    
                  <li><p>Training Schedules preparation.</p></li>
                     
                  <li><p>Store Auditing</p></li>
                      
                   <li><p>Wireman Data Collection</p></li>
                   
                   <li><p>Medical Fitness certificates collection.</p></li>
                 
                 <li><p>Thermography report preparation.</p></li>
                 
                 <li><p>Online survey completion.</p></li>
                  
                  <li><p>Monthly Annexure Documents.</p></li>
                   
                   </ul>
                    
                   <p>Start Date:<b><?php $t = strtotime($join_date);
