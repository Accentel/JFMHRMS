...
<div class="book">
 <div class="page">
	...
	$sal_th=$row['sal_th'];
        ...
        $t = strtotime($apdate);
        echo date('d-m-Y',$t);
        //echo date_format($apdate,"d-m-Y"); ?></b></p>
        <p>To:
        <br/><b><?php echo $address; ?></b></p>
           ...
           <p>We are pleased to appoint you as a <b><?php echo $desig; ?></b>&nbsp; in our organization</p>
             <p><b>Job Title: Technical Manager </b></p>
             <p><b>Job description:</b></p>
             <ul>
                 <li><p>Publishing the schedules of Thermography and execution at all stores in <?php echo $state; ?> State Region on half yearly basis.</p></li>
                 
                 <li><p>Publishing the training schedules and conducting regular Technical Training programs to technicians and Supervisors.</p></li>
                 
                 <li><p>PF maintenance at Sites (PF > 0.98) & FM Corner box record maintenance</p></li>
                  
                  <li><p>Planning and execution of CMPM As per the schedules.</p></li>
                   
                  <li><p>Attendance maintenance of Technicians through Digital platform (Mhere Pro- SCRUM IDs creation/arrangement).</p></li>
                    
                  <li><p>Follow-up for Daily Energy meter readings & Follow-up for PM Calls logging not less than 8 per Technician.</p></li>
                     
                  <li><p>Technician/Supervisor vacancies filling</p></li>
                      
                   <li><p>Follow-up for Dress Code Maintenance (Including Safety Shoe, ID Card) of Technicians/Supervisors.</p></li>
                   
                   <li><p>Scheduling for Store audits and execution.</p></li>
                 
                 <li><p>Follow-up for Medical Fitness certificates and Wire man certificates availability with all the Technicians.</p></li>
                 
                 <li><p>Follow-up for all the tools availability with the Technicians.</p></li>
                  
                  <li><p>Unlimited number of calls attending for any emergency breakdown on 24X7 basis.</p></li>
                   
                  <li><p>Preparation of Annexure and approval process with clients.</p></li> </ul>
       ...
       <p>&nbsp;&nbsp;&nbsp;&nbsp; We congratulate you on your appointment and wish you a long and successful career with us. We are confident that your contribution will take us further in our journey towards becoming world leaders. We assure you of our support for your professional development and growth.</p>
		 ...
		 <p>** Terms and conditions furnished</p> 
		 </div>
		 </div>
		 </div>
...
<div class="book">
		 ...
		 <p><b>Terms & Conditions:</b></p>
          ...
          <p><b>Certificates submitted to office: </b></p>
          <ol><li><?php echo $certi1; ?></li>
          <li><?php echo $certi2; ?></li></ol>
