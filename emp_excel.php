...
$objPHPExcel
 ...
 $objPHPExcel->getActiveSheet()->getStyle("A1:AA1")->getAlignment()->setHorizontal('center');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'EMPLOYEE LIST');
  $objPHPExcel->getActiveSheet()->getStyle("A4:AL4")->getAlignment()->setHorizontal('center');
